...
, SUM(CONVERT(bigint,vac.new_vaccinations)) OVER (Partition by cas.Location Order by cas.location, cas.Date) as RollingPeopleVaccinated
From Cases cas
...
-- should be created in a separate query
